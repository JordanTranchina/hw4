async function pageLoaded() {
  ...
  for (let i = 0; i < json.length; i++) {   // calling the arrays
    ...
    // if ride.lenth > 1 then level of service = Noober Pool
    // if purpleRequest = true, then level of service = Noober Purple
    // if number of total people is > 3, then level of service = Noober XL
    // esle Noober X
